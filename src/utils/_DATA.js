...
let tweets = {
  ...
  "3sklxkf9yyfowrf0o1ftbb": {
    ...
    likes: ['dan_abramov', 'joel_edwards'],
  ...
  "r0xu2v1qrxa6ygtvf2rkjw": {
    ...
    likes: ['tylermcginnis', 'joel_edwards'],
    replyingTo: "6h5ims9iks66d4m7kqizmv",
    replies: [],
  },
  "975761506330710016": {
    ...
    author: "joel_edwards",
    text: "React w/ Redux is absolutely outsanding. I love learning about React!",
    timestamp: 1510044395651,
    likes: ['tylermcginnis', 'sarah_edo', 'dan_abramov', 'joel_edwards'],
    replyingTo: null,
    replies: [],
  },
}
